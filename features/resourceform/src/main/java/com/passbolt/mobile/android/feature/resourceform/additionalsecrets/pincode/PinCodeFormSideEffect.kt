...
internal sealed interface PinCodeFormSideEffect {
    data object NavigateBack : PinCodeFormSideEffect

    data class NavigateToAdvancedGeneration(
        val pinCodeUiModel: PinCodeUiModel,
    ) : PinCodeFormSideEffect
