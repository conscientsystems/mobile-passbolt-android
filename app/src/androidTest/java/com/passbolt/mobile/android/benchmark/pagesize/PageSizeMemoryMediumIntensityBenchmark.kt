...
@LargeTest
class PageSizeMemoryMediumIntensityBenchmark {
    @get:Rule
    val setupRule = benchmarkSetupRule()

    @Test
    fun measurePeakHeapAcrossPageSizes() = PageSizeMemoryBenchmarkHarness(MetadataProfile.MEDIUM).execute()
}
