...
val foldersDataModule =
    module {
        single { get<RestService>().service(FoldersApi::class.java) }

        singleOf(::FoldersLocalDataSourceImpl) bind FoldersLocalDataSource::class
        singleOf(::FoldersRemoteDataSourceImpl) bind FoldersRemoteDataSource::class

        singleOf(::FoldersRepositoryImpl) bind FoldersRepository::class
    }
