...
internal class GlobalPreferencesRepositoryImpl(
    ...
    override fun getGlobalPreferences(): GlobalPreferencesUiModel = localDataSource.getGlobalPreferences()

    override fun updateGlobalPreferences(update: GlobalPreferencesUpdate) = localDataSource.updateGlobalPreferences(update)
}
