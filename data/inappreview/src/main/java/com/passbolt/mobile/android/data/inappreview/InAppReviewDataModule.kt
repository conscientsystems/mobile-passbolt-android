...
val inAppReviewDataModule =
    module {
        singleOf(::InAppReviewShowSerializer)
        singleOf(::InAppReviewLocalDataSourceImpl) bind InAppReviewLocalDataSource::class
        singleOf(::InAppReviewRepositoryImpl) bind InAppReviewRepository::class
    }
