...
internal class InAppReviewRepositoryImpl(
    ...
    override fun getInAppReviewParameters(userId: String): InAppReviewParameters = localDataSource.getInAppReviewParameters(userId)

    override fun saveInAppReviewParameters(
        userId: String,
        parameters: InAppReviewParameters,
    ) = localDataSource.saveInAppReviewParameters(userId, parameters)

    override fun getInAppReviewShowMode(userId: String): InAppReviewShowMode = localDataSource.getInAppReviewShowMode(userId)

    override fun saveInAppReviewShowMode(
        userId: String,
        showMode: InAppReviewShowMode,
    ) = localDataSource.saveInAppReviewShowMode(userId, showMode)
}
