...
internal fun BaseResponse<ServerPgpResponseDto>.toDomain(): ServerPgpKey =
    ServerPgpKey(
        fingerprint = body.fingerprint,
        keyData = body.keydata,
        serverTimeSeconds = header.serverTime,
    )

internal fun BaseResponse<ServerRsaResponseDto>.toDomain(): ServerRsaKey =
    ServerRsaKey(
        keyData = body.keydata,
    )
