...
class AddLocalResourcePermissionsUseCase(
    ...
    override suspend fun execute(input: Input) {
        ...
        resourcesRepository.addLocalResourcePermissions(
            input.resourcesWithTagsModelAndGroups.map { it.toDomain() },
            userId,
        )
    }

    data class Input(
        val resourcesWithTagsModelAndGroups: List<ResourceUiModelWithAttributes>,
    )
}
