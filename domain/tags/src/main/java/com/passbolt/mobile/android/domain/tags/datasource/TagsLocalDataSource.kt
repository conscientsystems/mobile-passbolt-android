package com.passbolt.mobile.android.domain.tags.datasource
...
interface TagsLocalDataSource {
    ...
    suspend fun getTagsWithCount(
        searchQuery: String?,
        userId: String,
    ): List<TagWithCount>

    fun getTagsWithCountPaginated(
        searchQuery: String?,
        pageSize: Int,
        userId: String,
    ): Flow<PagingData<TagWithCount>>

    suspend fun removeTags(userId: String)
}
