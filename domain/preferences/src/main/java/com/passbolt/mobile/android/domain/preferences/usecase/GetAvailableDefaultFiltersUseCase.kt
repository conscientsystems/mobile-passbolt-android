 ...
 * @since v1.0
 */
class GetAvailableDefaultFiltersUseCase(
    private val accountPreferencesRepository: AccountPreferencesRepository,
) : UseCase<Unit, List<DefaultFilterUiModel>> {
    override fun execute(input: Unit): List<DefaultFilterUiModel> = accountPreferencesRepository.availableDefaultFilters()
}
