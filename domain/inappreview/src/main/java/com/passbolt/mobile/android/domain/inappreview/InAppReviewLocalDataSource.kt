...
interface InAppReviewLocalDataSource {
    fun getInAppReviewParameters(userId: String): InAppReviewParameters

    fun saveInAppReviewParameters(
        userId: String,
        parameters: InAppReviewParameters,
    )

    fun getInAppReviewShowMode(userId: String): InAppReviewShowMode

    fun saveInAppReviewShowMode(
        userId: String,
