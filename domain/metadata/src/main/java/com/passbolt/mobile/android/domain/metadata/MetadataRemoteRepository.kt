...
interface MetadataRemoteRepository {
    suspend fun fetchMetadataKeys(): DomainResult<List<MetadataKey>>

    suspend fun fetchMetadataKeysSettings(): DomainResult<MetadataKeysSettings>

    suspend fun fetchMetadataTypesSettings(): DomainResult<MetadataTypesSettings>

    suspend fun fetchMetadataSessionKeys(): DomainResult<List<MetadataSessionKeysBundle>>
    ...
    suspend fun postMetadataSessionKeys(encryptedData: String): DomainResult<Unit>
