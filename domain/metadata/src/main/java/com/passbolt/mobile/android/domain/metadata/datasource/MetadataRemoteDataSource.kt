...
interface MetadataRemoteDataSource {
    suspend fun getMetadataKeys(): DomainResult<List<MetadataKey>>

    suspend fun getMetadataKeysSettings(): DomainResult<MetadataKeysSettings>

    suspend fun getMetadataTypesSettings(): DomainResult<MetadataTypesSettings>

    suspend fun getMetadataSessionKeys(): DomainResult<List<MetadataSessionKeysBundle>>
