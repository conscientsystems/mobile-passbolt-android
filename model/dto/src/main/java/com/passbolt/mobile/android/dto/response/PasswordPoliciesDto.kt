...
data class PasswordPoliciesDto(
    ...
    val defaultGenerator: PasswordGeneratorTypeDto,
    @SerializedName("password_generator_settings")
    val passwordGeneratorSettings: PasswordGeneratorSettingsDto,
    @SerializedName("passphrase_generator_settings")
    val passphraseGeneratorSettings: PassphraseGeneratorSettingsDto,
    @SerializedName("external_dictionary_check")
    val externalDictionaryCheck: Boolean,
)

data class PasswordGeneratorSettingsDto(
    val length: Int,
...
data class PassphraseGeneratorSettingsDto(
    val words: Int,
    @SerializedName("word_separator")
    val wordSeparator: String,
    @SerializedName("word_case")
    val wordCase: CaseTypeDto,
)

enum class PasswordGeneratorTypeDto {
