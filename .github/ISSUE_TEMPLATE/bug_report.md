---
name: Report a bug
about: Report a bug in the Passbolt Android application.
title: ""
labels: bug
assignees: ""
---
...
This tracker is only for Android application bugs. For anything else:
...
If you are certain this is an Android application bug, please fill in the format below.
-->

* Application version: <!-- e.g. 3.1.0 -->
...
<!-- Log file is of great help when debugging -->
<!-- https://www.passbolt.com/docs/hosting/maintenance/diagnostics/collect-info/#mobile-applications -->
